<header class="bg-gray-300 p-4 flex justify-between items-center">
   ...
   <a class="bg-black text-white px-6 py-2 rounded-full shadow-md" href="{{ route('DashboardUser') }}">Beranda</a>
    <a class="bg-black text-white px-6 py-2 rounded-full shadow-md" href="{{ route('MapsUser') }}">Maps</a>
    <a class="bg-black text-white px-6 py-2 rounded-full shadow-md" href="{{ route('ServicesUser') }}">Services</a>
    <a class="bg-black text-white px-6 py-2 rounded-full shadow-md" href="{{ route('riwayat.transaksi') }}">Riwayat Transaksi</a>
    @auth
